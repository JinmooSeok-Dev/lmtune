...
# Native Pruner — Optuna 위임 없이 stdlib 만으로 동작. PLUG slot 의 합류.
_NATIVE_PRUNER_KINDS = {"median_native", "percentile_native"}
